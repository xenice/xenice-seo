        ...
        if(isset($_POST['return'])){
            ...
            if($result['return'] == 'success'){
                ...
                <div class="notice notice-success is-dismissible"> 
            	    <p><strong><?=$result['message']??$option['title'].' '.__('save success')?></strong></p>
                </div>
                <?php
            }
            elseif($result['return'] == 'error'){
                ...
                <div class="notice notice-error is-dismissible"> 
            	    <p><strong><?=$result['message']??$option['title'].' '.__('save failed')?></strong></p>
                </div>
                <?php
            }
            ...
            <form method="post" action="" id="xenice_option_form">
                ...
                <p class="submit">
                    <?php 
                        ...
                        echo $buttons;
                        // echo Space::call('xenice_options_button',$buttons, $option['id'],$option['tab_key']??null);
                    ?>
                </p>
            </form>
        </div>
